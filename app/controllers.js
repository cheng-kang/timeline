...
timelineControllers.controller('OptionCtrl', ['$scope', "OptionService", "AuthService",
...
timelineControllers.controller('BlogListCtrl', ['$scope', "BlogService", "OptionService",
...
timelineControllers.controller('BlogDetailCtrl', ['$scope', "$location", "BlogService", "OptionService", "$sce", "$routeParams",
...
timelineControllers.controller('BlogPostCtrl', ['$scope', "OptionService", "BlogService", "$window",
...
timelineControllers.controller('BlogEditCtrl', ['$scope', "OptionService", "BlogService", "$window", "$firebaseObject", "$sce", "$routeParams",
...
timelineControllers.controller('CatAllCtrl', ['$scope', "BlogService", "OptionService",
	function ($scope, BlogService, OptionService){
...
timelineControllers.controller('CatOneCtrl', ['$scope', "BlogService", "OptionService", "$routeParams",
...
timelineControllers.controller('TagAllCtrl', ['$scope', "BlogService", "OptionService",
	function ($scope, BlogService, OptionService){
...
timelineControllers.controller('TagOneCtrl', ['$scope', "BlogService", "OptionService", "$routeParams",
	function ($scope, BlogService, OptionService, $routeParams){
...
timelineControllers.controller('ArchiveCtrl', ['$scope', "BlogService", "OptionService",
	function ($scope, BlogService, OptionService){
        $scope.blogs = BlogService.getAll();
...
timelineControllers.controller('ConfigCtrl', ['$scope', "$window", "AuthService", "OptionService", "$firebaseObject",
...
timelineControllers.controller('LoginCtrl', ['$scope', "$window", "AuthService", "OptionService",
