...
public struct Configuration {
  ...
  public static var numberLabelFont = UIFont.init(name: "HelveticaNeue-Bold", size: 19)!
  public static var doneButton = UIFont.init(name: "HelveticaNeue-Medium", size: 19)!
  public static var flashButton = UIFont.init(name: "HelveticaNeue-Medium", size: 12)!
  public static var noImagesFont = UIFont.init(name: "HelveticaNeue-Medium", size: 18)!
  public static var noCameraFont = UIFont.init(name: "HelveticaNeue-Medium", size: 18)!
    
  public static var settingsFont = UIFont.init(name: "HelveticaNeue-Medium", size: 16)!
